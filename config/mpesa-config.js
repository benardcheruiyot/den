...
module.exports = {
    ...
    CALLBACK_URL: process.env.MPESA_CALLBACK_URL || 'https://pata.mkopaji.com/api/mpesa-callback',
    TIMEOUT_URL: process.env.MPESA_TIMEOUT_URL || 'https://pata.mkopaji.com/api/mpesa-timeout',
    RESULT_URL: process.env.MPESA_RESULT_URL || 'https://pata.mkopaji.com/api/mpesa-result',
