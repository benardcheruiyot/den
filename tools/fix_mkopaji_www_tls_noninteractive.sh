...
DOMAIN="pata.mkopaji.com"
WWW="www.pata.mkopaji.com"
SITE_CONF="/etc/nginx/sites-available/pata.mkopaji.conf"
SITE_LINK="/etc/nginx/sites-enabled/pata.mkopaji.conf"
...
# pata.mkopaji.com site config - created by automation
server {
  listen 80;
  server_name pata.mkopaji.com www.pata.mkopaji.com;
  return 301 https://pata.mkopaji.com$request_uri;
}

server {
  listen 443 ssl;
  server_name pata.mkopaji.com;

  root /var/www/html/kopesha-loan-app;
  index index.html index.htm;

  ssl_certificate /etc/letsencrypt/live/pata.mkopaji.com/fullchain.pem;
  ssl_certificate_key /etc/letsencrypt/live/pata.mkopaji.com/privkey.pem;
...
server {
  listen 443 ssl;
  server_name www.pata.mkopaji.com;
