    ...
    async initiateSTKPush(phoneNumber, amount, accountReference, transactionDesc) {
        try {
            ...
            const payload = {
                ...
                PartyB: '6415766', // Use Till number instead of business shortcode
                PhoneNumber: formattedPhone,
                CallBackURL: mpesaConfig.CALLBACK_URL,
                AccountReference: accountReference || 'PATA.MKOPAJI-LOAN',
                TransactionDesc: transactionDesc || 'PATA.MKOPAJI Loan Processing Fee'
            };
